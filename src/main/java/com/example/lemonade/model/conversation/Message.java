package com.example.lemonade.model.conversation;
...
@Data
@XmlRootElement(name = "Message") // Defines root XML element
@XmlAccessorType(XmlAccessType.FIELD) // Maps all fields automatically
